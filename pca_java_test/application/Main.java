...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			final ScatterChart<Number, Number> scatterplot = new ScatterChart<Number, Number>(xAxis,yAxis);
			xAxis.setLabel("Age (years)");
			yAxis.setLabel("Returns to date");
			scatterplot.setTitle("Investments Overview");
			...
			scatterplot.getData().addAll(series1, series2);
